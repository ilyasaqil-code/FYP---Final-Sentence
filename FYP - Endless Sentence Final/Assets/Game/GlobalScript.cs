...
public partial class GlobalScript : GlobalScriptBase<GlobalScript>
{
	...
	/// Called when player interacted with something that had no specific "interact" script
	...
	/// Called when player looked at something that had no specific "Look at" script
